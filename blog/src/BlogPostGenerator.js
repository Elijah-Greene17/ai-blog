    ...
    <div className="main">
        ...
        <div className="modal" ref={modalRef}>
          <div className="modal-content">
            <form>
              <label>
                Temperature:
                <input type="text" value={temp} onChange={(event) => handleChange(event, setTemp)} />
              </label>
              <br />
              <label>
                Maximum Tokens:
                <input type="text" value={max_tok} onChange={(event) => handleChange(event, setMaxTok)} />
              </label>
              <br />
              <label>
                Frequency Penalty:
                <input type="text" value={freq} onChange={(event) => handleChange(event, setFreq)} />
              </label>
              <br />
              <label>
                Presence Penalty:
                <input type="text" value={pres} onChange={(event) => handleChange(event, setPres)} />
              </label>
              <br />
      ...
      <div className="main-child">
        ...
        <div className="btn-row">
          <button onClick={handleWrite} className={contentIsWriting && "disabled"}>
            {contentIsWriting ? <b>Writing...</b> : <b>Write</b>}
          </button>
          <button className="settings-btn" onClick={openModal}><span>ai settings</span></button>
        </div>
      ...
      <div className="main-child">
        ...
        {contentIsLoading
          ...
          :
          <textarea ref={textareaRef} className="content" value={content} />
        }
